...
exports.parsePropertiesContent = parsePropertiesContent;
 ...
 * ```
 */
function parsePropertiesContent(content, filePath) {
    const entries = [];
    const lines = content.split(/\r?\n/);
    let continuedLine = '';
    let continuedLineNumber;
    ...
    return {
        filePath,
        entries,
        format: domain_1.ConfigFileFormat.PROPERTIES,
    };
}
/**
 ...
 */
function parsePropertyLine(line, filePath, lineNumber) {
