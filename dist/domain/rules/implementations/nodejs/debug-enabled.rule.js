...
exports.nodejsDebugEnabledRule = void 0;
 ...
 */
exports.nodejsDebugEnabledRule = {
    id: 'NODEJS_DEBUG_ENABLED',
    name: 'Debug Mode Enabled',
    description: 'Detects when debug logging or debug mode is enabled. ' +
        ...
        if (DANGEROUS_VALUES.includes(normalizedValue)) {
            return [
                (0, violation_1.createViolation)({
                    ...
                    message: `Debug logging is enabled via ${entry.key}="${entry.value}". ` +
                        `This may expose sensitive application details in logs.`,
                    filePath: entry.sourceFile,
                    configKey: entry.key,
                    configValue: entry.value,
                    lineNumber: entry.lineNumber,
                    suggestion: `Set ${entry.key} to "info", "warn", or "error" in production. ` +
...
//# sourceMappingURL=debug-enabled.rule.js.map